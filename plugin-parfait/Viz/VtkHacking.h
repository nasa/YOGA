...
class vtkHackCommunicator : public vtkCommunicator {
  public:
    ...
    int SendVoidArray(const void* buff, vtkIdType length, int type, int remotehandle, int tag) { return 1; }
...
class vtkHackController : public vtkMultiProcessController {
  public:
    ...
    virtual void SetCommunicator(vtkCommunicator* comm) { Communicator = comm; };
