...
TEST_CASE("dog"){
    ...
    SECTION("get nodes"){
        ...
        auto err = mangle(tinf_mesh_nodes_coordinates)(mesh_handle, TINF_DOUBLE, 0, 2,
                                    (void*)x.data(),
                                    (void*)y.data(),
                                    (void*)z.data());
    ...
    SECTION("get complex error"){
        ...
        auto error = mangle(tinf_mesh_nodes_coordinates)(mesh_handle, TINF_CMPLX_DOUBLE, 0, 2,
                                    (void*)x.data(),
                                    (void*)y.data(),
                                    (void*)z.data());
