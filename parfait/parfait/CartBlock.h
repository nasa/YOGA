...
class CartBlock : public Extent<double> {
  public:
    CartBlock() = delete;
    CartBlock(int ncell_x, int ncells_y, int ncells_z);
    CartBlock(const Point<double>& min_xyz, const Point<double>& max_xyz, int ncells_x, int ncells_y, int ncells_z);
    CartBlock(const Extent<double>& extent, int ncells_x, int ncells_y, int ncells_z);
    ...
    Extent<int> getRangeOfOverlappingCells_dep(const Extent<double>& search_extent) const;
