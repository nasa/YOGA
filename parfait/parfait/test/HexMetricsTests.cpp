...
TEST_CASE("Hex Center") {
    ...
    auto center = std::accumulate(hex.begin(), hex.end(), Parfait::Point<double>{}) / 8.0;
    REQUIRE(center.approxEqual(Parfait::CGNS::Hex::computeCenter(hex)));
}
