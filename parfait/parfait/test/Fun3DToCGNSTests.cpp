...
TEST_CASE("Fun3DToCGNS, tetsDontChange") {
    ...
    auto original = tet;
    Parfait::Fun3DToCGNS::convertTet(tet.data());
...
TEST_CASE("Fun3DToCGNS, pyramidsDontChange") {
    ...
    Parfait::Fun3DToCGNS::convertPyramid(pyramid.data());
...
TEST_CASE("Fun3DToCGNS, prismsDoChange") {
    ...
    Parfait::Fun3DToCGNS::convertPrism(prism.data());
...
TEST_CASE("Fun3DToCGNS, hexsDoChange") {
    ...
    Parfait::Fun3DToCGNS::convertHex(hex.data());
