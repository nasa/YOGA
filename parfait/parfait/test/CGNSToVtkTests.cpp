...
TEST_CASE("CGNSToVtk, tetsDontChange") {
    ...
    auto original = tet;
    Parfait::CGNSToVtk::convertTet(tet.data());
...
TEST_CASE("CGNSToVtk, pyramidsDontChange") {
    ...
    Parfait::CGNSToVtk::convertPyramid(pyramid.data());
...
TEST_CASE("CGNSToVtk, prismsDontChange") {
    ...
    auto original = prism;
    Parfait::CGNSToVtk::convertPrism(prism.data());
...
TEST_CASE("CGNSToVtk, hexsDontChange") {
    ...
    auto original = hex;
    Parfait::CGNSToVtk::convertHex(hex.data());
